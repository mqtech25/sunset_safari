        ...
        <div class="col-md-6 mx-auto">
            <div class="card">
                ...
                <div class="border-top card-body">
                    <p class="d-inline-block w-50">Don't have an account? <a href="{{ route('register') }}">Sign Up</a></p><p class="d-inline-block w-50 text-right"><a href="{{ route('password.request') }}">Forgot Password ?</a></p>
                </div>
            </div>
        </div>
    </div>
