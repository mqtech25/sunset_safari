...
<body style="margin: 0; padding: 0;">
    <div style="width: 60%; margin:0px auto">
        <p>Hi, <strong>{{$order->first_name.' '.$order->last_name}}</strong><br> Here is reciept for your order <strong>#{{$order->order_number}}</strong></p><br>
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-left: 1px solid gray; border-right: 1px solid gray;">
            ...
            <tr>
                <td colspan=" 3 " align="center " style="background-color: #ece9e9; padding: 10px">
                    <p>Thank you for your order. You will get an Email when your order is shipped.<br>for any query please contact us on : {{config('settings.default_email_address')}}</p>
                </td>
            </tr>
        </table>
    </div>
