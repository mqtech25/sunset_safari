    ...
    <form action="{{ route('admin.settings.update') }}" method="POST" role="form">
        ...
        <div class="tile-body">
            ...
            <div class="form-row">
                <div class="col-6">
                    <div class="form-group">
                        <label class="control-label" for="default_email_address">Site Email Address</label>
                        <input
                            class="form-control"
                            type="email"
                ...
                <div class="col-6">
                    <div class="form-group">
                        <label class="control-label" for="default_phone_number">Site Phone Number</label>
                        <input
                            class="form-control"
                            type="tel"
                            placeholder="Enter store default email address"
            ...
            <div class="form-group">
                <label class="control-label" for="default_site_address">Address</label>
                <input
                    class="form-control"
                    type="text"
                    placeholder="Enter store address"
                    id="default_site_address"
                    name="default_site_address"
                    value="{{ config('settings.default_site_address') }}"
                />
            </div>
        </div>
