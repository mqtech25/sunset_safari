			...
			<div class="container">
				<div class="row">
					<div class="col-md-3 col-sm-3 col-xs-3">
						<div id="logo_home">
							<h1><a href="index.html" title="Sunset Safari Travel">Sunset Safari Travel&amp; More</a></h1>
						</div>
					</div>
					<nav class="col-md-9 col-sm-9 col-xs-9">
						...
						<div class="main-menu">
							<div id="header_menu">
								<img src="{{asset('frontend/images/logo_menu.png')}}" width="145" height="34" alt="Bestours">
							</div>
							<a href="#" class="open_close" id="close_in"><i class="icon_set_1_icon-77"></i></a>
							<ul>
								<li class="megamenu submenu">
									<a href="javascript:void(0);" class="show-submenu-mega">Desert Tour</a>
									<div class="menu-wrapper">
										<div class="row">
											<div class="col-md-4">
												<h3>Museum Tours</h3>
												<div class="menu-item">
													<a href="#"><img src="{{asset('frontend/images/menu-demo-1.jpg')}}" width="400" height="226" alt="" class="img-responsive">
													</a>
													<p>
											...
											<div class="col-md-4">
												...
												<div class="menu-item">
													<a href="#"><img src="{{asset('frontend/images/menu-demo-2.jpg')}}" width="400" height="226" alt="" class="img-responsive">
													</a>
													<p>
														Lorem ipsum dolor sit amet, et cum civibus referrentur, at propriae forensibus qui. Duo aliquip necessitatibus ne.
													</p>
											...
											<div class="col-md-4">
												<h3>Travel Tours</h3>
												<div class="menu-item">
													<a href="#"><img src="{{asset('frontend/images/menu-demo-3.jpg')}}" width="400" height="226" alt="" class="img-responsive">
													</a>
													<p>
														Lorem ipsum dolor sit amet, et cum civibus referrentur, at propriae forensibus qui. Duo aliquip necessitatibus ne.
													</p>
										...
										<p class="text-center hidden-xs">
											<a href="#" class="btn_outline">MORE SOON</a>
									</div>
									<!-- End menu-wrapper -->
								</li>
								<li class="megamenu submenu">
									<a href="javascript:void(0);" class="show-submenu-mega">City Tour</a>
									<div class="menu-wrapper">
										<div class="row">
											<div class="col-md-4">
												<h3>Museum Tours</h3>
								...
								<li class="megamenu submenu">
									<a href="javascript:void(0);" class="show-submenu-mega">Deals Offers</a>
									<div class="menu-wrapper">
										<div class="row">
											<div class="col-md-4">
												<h3>Museum Tours</h3>
								...
								<li class="megamenu submenu">
									<a href="javascript:void(0);" class="show-submenu-mega">Self Drive</a>
									<div class="menu-wrapper">
										<div class="row">
											<div class="col-md-4">
												<h3>Museum Tours</h3>
								...
								<li class="megamenu submenu">
									<a href="javascript:void(0);" class="show-submenu-mega">Dhow Cruise</a>
									<div class="menu-wrapper">
										<div class="row">
											<div class="col-md-4">
												<h3>Museum Tours</h3>
								...
								<li class="megamenu submenu">
									<a href="javascript:void(0);" class="show-submenu-mega">Special Tours</a>
									<div class="menu-wrapper">
										<div class="row">
											<div class="col-md-4">
												<h3>Museum Tours</h3>
