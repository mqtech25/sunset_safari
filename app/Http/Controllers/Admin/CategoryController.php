...
class CategoryController extends BaseController
{
	...
	*/
	public function store(Request $request){
		...
		if(!$category){
			return $this->responseRedirectBack('Error occurred while creating category Or Category already exists', 'error', true, true);
		}
	...
	*/
	...
	public function delete($id){
		...
		if(!$deleteCategory){
			return $this->responseRedirectBack('Error occurred while deleting categories Or deleting parent category is not allowed', 'error', true, true);
		}
